"""Config flow for Better User Settings."""
...
class BetterUserSettingsConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Better User Settings."""
    ...
    def async_get_options_flow(
        ...
        return BetterUserSettingsOptionsFlow(config_entry)
    ...
    async def async_step_user(
        ...
        return self.async_create_entry(
            title="Better User Settings",
            data={},
            options=_default_options(),
        )


class BetterUserSettingsOptionsFlow(config_entries.OptionsFlow):
    """Handle Better User Settings options."""
...
def _default_options() -> dict[str, Any]:
    ...
    return {
        CONF_USERS_YAML: DEFAULT_USERS_YAML,
        CONF_GROUPS_YAML: DEFAULT_GROUPS_YAML,
        CONF_DASHBOARDS_YAML: DEFAULT_DASHBOARDS_YAML,
        CONF_DEFAULT_DASHBOARD_YAML: DEFAULT_DASHBOARD_YAML,
        OPT_HIDE_SIDEBAR_ITEMS: DEFAULT_OPTIONS[OPT_HIDE_SIDEBAR_ITEMS],
        OPT_REDIRECT_BLOCKED_DASHBOARDS: DEFAULT_OPTIONS[
            OPT_REDIRECT_BLOCKED_DASHBOARDS
        ],
        OPT_HIDE_ADMIN_MENU_FOR_NON_ADMIN: DEFAULT_OPTIONS[
            OPT_HIDE_ADMIN_MENU_FOR_NON_ADMIN
        ],
        OPT_DEBUG: DEFAULT_OPTIONS[OPT_DEBUG],
    }
